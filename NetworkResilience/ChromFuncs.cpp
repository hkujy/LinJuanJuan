...
//
//};
//void CHROME::ReviseCap(GraphClass &Graph){
//
...
//}
//
//void CHROME::IniCap(GraphClass &ScenarioGraph){
//	for (unsigned int i = 0; i < this->Nodes.size(); i++)
//	{
//		int n = this->Nodes.at(i);
//		// incoming link
...
////	return r;
////}
////void CHROME::EvaluateSol(GraphClass &Graph, const double BaseUNPM, const NODEPROMATRIX &NodeProbMatrix,
